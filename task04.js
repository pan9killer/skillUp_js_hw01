...
let droidSum = prompt('Сколько ремонтных дройдов вы хотите купить?');
let totalPrice = droidSum * pricePerDroid;
if (droidSum === null || droidSum == 0) {
    console.log('Отменено пользователем!');
} else if (totalPrice <= credits) {
    console.log('Вы купили ' + droidSum + ' дроидов, на счету осталось ' + (credits - totalPrice) + ' кредитов.');
} else {
